    ...
    >
      ...
      >
        ...
        {uploadSuccess.success === true && (
          ...
          "
          >
            Upload Successful! Please check your developer page for the status
            of your upload, or upload another file.
          </Typography>
        )}
        {uploadSuccess.success === false && (
          ...
          >
            ...
            to receive issues with the upload, please file an issue at our
            github page,{" "}
