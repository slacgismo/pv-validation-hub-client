...
export default function SubmissionUploader({
	...
	const handleUpload = () => {
		...
		if (typeof analysisId === 'number' && file.file !== null) {
			...
			responsePromise = Promise.reject(
				new Error('Analysis ID not found')
			);
		}
	...
	useEffect(() => {
		if (uploadSuccess.success === null || uploadSuccess.success === false) {
			return;
		}
    ...
    "
      ...
      "
          ...
          "
					>
						Upload Successful! Please check your developer page for
						the status of your upload, or upload another file.
					</Typography>
				)}
          ...
          "
					>
						Upload failed. Please reload the page and try again. If
						you continue to receive issues with the upload, please
						file an issue at our github page,{' '}
